...
def read_input(fname):
    ...
    stacks = stacks.splitlines(False)[:-1]

    stacks = parse_stacks(stacks, step=4)

    instruction_list = parse_instructions(instructions)
        
    return instruction_list, stacks
...
def solve_1(fname):
    ins,stacks = read_input(fname)
    follow_instructions_1(ins, stacks)
    #print_stacks(stacks)

def solve_2(fname):
    ins,stacks = read_input(fname)
    follow_instructions_2(ins, stacks)
    #print_stacks(stacks)
